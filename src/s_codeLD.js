//Build Data: app.lexus.lexusdrivers - 2015_06_01_09_21';
/*
...
function Visitor(k,s){if(!k)throw"Visitor requires Adobe Marketing Cloud Org ID";var a=this;a.version="1.3.2";var h=window,m=h.Visitor;h.s_c_in||(h.s_c_il=[],h.s_c_in=0);a._c="Visitor";a._il=h.s_c_il;a._in=h.s_c_in;a._il[a._in]=a;h.s_c_in++;var x=h.document,j=h.O;j||(j=null);var i=h.P;i||(i=!0);var q=h.N;q||(q=!1);a.C=function(a){var c=0,b,e;if(a)for(b=0;b<a.length;b++)e=a.charCodeAt(b),c=(c<<5)-c+e,c&=c;return c};a.m=function(a){var c="0123456789",b="",e="",f,g=8,h=10,i=10;if(1==a){c+="ABCDEF";for(a=
    ...
    **********************************************************************/
    ...
    var tmsomni = ( function() {
      ...
      s.s_code_version =  s.version+'__2015_06_01_09_21';
    
      // account selection
      var s_account = (document.domain.match(/^(www|auth\d*?|secure|touch|ssl|drivers|m)\.(?!(tstcpd|devcpd|staging))/i)?"tmslexusowners,tmslexusdealernational":"tmslexusownersdev");
    ...
    *********************************************************************/
    s.fixReferrer=function(a){
      function f(a,b){d[a]=b}
      function g(a,b,c){e.push({p:a,r:b,c:c})}
      function h(a){for(var f,g,h=0,i=e.length;i>h;h++)if(g=e[h],c.hasOwnProperty(g.p)||(c[g.p]=b.Util.getQueryParam(g.p,"",a)),f=c[g.p],f.match(g.r))return d[g.c]+f;return""}
      function i(){c=[],d={},e=[]}
      var b=a,c=[],d={},e=[];return{setCategory:f,addRule:g,fix:h,reset:i}
    }(s);
    
    /*!*******************************************************************
    * fullyDecodeURIComponent Plugin v1.0 (CPD)
    *********************************************************************/
    s.fullyDecodeURIComponent=function(a){for(var b=a||"",c="";b!==c;)c=b,b=decodeURIComponent(c);return b};
    ...
    *********************************************************************/
    s.getQueryParam=function(a,b,c){var d,e,f,h,i,j,k,l,m,n=[],o=typeof b,p=typeof c,q="undefined",r=window.location;if(!a)return"";o===q&&p===q?(d="",e=r.href,f=r.search):"string"===o&&p===q?(d="",e=b):(d=b,e=c),typeof f===q&&(r=document.createElement("a"),r.href=e,f=r.search),"?"===f.charAt(0)&&(f=f.substr(1)),j=f.split("&"),i={};for(var t=j.length;t;t--)l=j[t-1],l&&(l=l.split("="),k=String(l.shift()).toLowerCase(),i[k]=l.join("="));for(h=String(a).toLowerCase().split(","),t=0;t<h.length;t++)k=h[t],"string"==typeof i[k]&&(m=i[k].replace(/\+/g," "),"function"==typeof s.fullyDecodeURIComponent?n.push(s.fullyDecodeURIComponent(m)):n.push(decodeURIComponent(m)));return 0===n.length&&n.push(d),n.join("")};
    
    /*********************************************************************
     * Plugin: getReferrerType v1.1
     *********************************************************************/
    s.getReferrerType=function(a){
      function i(){c=[],d={},e=[],f=[],g=[],h="default",j(h,"Typed/Bookmarked")}
      function j(a,b){d[a]=b}
      function k(a,b,c){f.push({p:b,r:c,c:a})}
      function l(a,b){var c;"string"!=typeof b&&(b=""),b=b.split(",").join("|");try{c=new RegExp("("+b+")$","gi")}catch(d){return}e.push({r:c,c:a})}
      function m(a,b,c){g.push({p:a,d:b,o:c})}
      function n(a,b){var c,f,e="",g=o(a);return b&&(e=p(b)),f=q(g,e),c=f||g||e,c&&d.hasOwnProperty(c)||(c=h),d[c]}
      function o(a){for(var c,d,e={},g=0,h=f.length;h>g;g++)if(d=f[g],e.hasOwnProperty(d.p)||(e[d.p]=b.Util.getQueryParam(d.p,"",a)),c=e[d.p],c.match(d.r))return d.c;return""}
      function p(a){for(var c,d=s(a),f=0,g=e.length;g>f;f++)if(c=e[f],d.match(c.r))return c.c;return""}
      function q(a,b){for(var d,f=0,h=g.length;h>f;f++)if(d=g[f],d.p==a&&d.d==b)return d.o;return""}
      function r(a){var b=document.createElement("a");return b.href=a,b}function s(a){return r(a).hostname}
      var c,d,e,f,g,h,b=a;return i(),{addType:j,addParamRule:k,addDomRule:l,addOverride:m,getType:n,reset:i}
    }(s);
    
    /*!********************************************************************
    * Guid Generator v 1.0
    *********************************************************************/
    s.guidGenerator=function(a,b){return a=a||"xxxxxxxxxxxxxxxx_xxxxxxxxxxxxxxxx",b=b||16,a.replace(/[x]/g,function(){var c=0|Math.random()*b;return c.toString(b)})};
    ...
    *********************************************************************/
    s.manageEvents=function(a){
      function c(a){var c=b.events||"";return b.manageList.add(c,a,",",1)}
      function d(a){var c=b.events||"";return b.manageList.update(c,a,",",1)}
      function e(a){var c=b.events||"";return b.manageList.remove(c,a,",",1)}
      function f(a){var c=b.events||"";return b.manageList.containsAny(c,a,",",1)}
      function g(a){var c=b.events||"";return b.manageList.containsAll(c,a,",",1)}
      var b=a;
      return{add:c,update:d,remove:e,containsAny:f,containsAll:g}
    }(s);
    
    /*!*******************************************************************
     * manageList Plugin v 1.0
     *********************************************************************/
    s.manageList=function(a){
      function f(a,b){var d,f,g,h,i,e=[];b=b||c,d=a?String(a).split(b):"";for(var j=0,k=d.length;k>j;j++)f=d[j].split("="),g=f.length>1?f[1]:"",f=f[0].split(":"),h=f.length>1?f[1]:"",i=f[0],i&&e.push({name:i,serial:h,value:g});return e}
      function g(a,b){var e,f,d=[];b=b||c;for(var g=0,h=a.length;h>g;g++)e=a[g],f=e.name,f+=e.serial?":"+e.serial:"",f+=e.value?"="+e.value:"",d.push(f);return d.join(b)}
      function h(a,b){return String(a)===String(b)}
      function i(a,b){return String(a).toLowerCase()===String(b).toLowerCase()}
      function j(){return!1}
      function k(a){return a=String(a).toLowerCase(),"1"===a?i:"2"===a?h:j}
      function l(a,b,c){var e,d=[];e=k(c);for(var f=a.length-1;f+1;f--)if(e(b.name,a[f].name)){d.push(f);break}return d}
      function m(a,b,h,i){var j,k,m;h=h||c,i=typeof i===e?d:i,j=f(a,h),k=f(b,h);for(var n=0,o=k.length;o>n;n++)m=l(j,k[n],i),m.length||j.push(k[n]);return g(j,h)}
      function n(a,b,h,i){var j,k,m;h=h||c,i=typeof i===e?d:i,j=f(a,h),k=f(b,h);for(var n=0,p=k.length;p>n;n++)m=l(j,k[n],i),m.length?o(j,m,k[n]):j.push(k[n]);return g(j,h)}
      function o(a,b,c){for(var d,e=0,f=b.length;f>e;e++)d=b[e],a[d]=c}function p(a,b,h,i){var j,k,m;h=h||c,i=typeof i===e?d:i,j=f(a,h),k=f(b,h);for(var n=0,o=k.length;o>n;n++)m=l(j,k[n],i||2),j=r(j,m);return g(j,h)}
      function q(a,b,h,i){var j;return h=h||c,i=typeof i===e?d:i,j=f(a,h),"[object Array]"!==Object.prototype.toString.call(b)&&(b=f(b,h)),j=r(j,b),g(j,h)}
      function r(a,b){b=b.sort(function(a,b){return b-a});for(var c=0,d=b.length;d>c;c++)a.splice(b[c],1);return a}
      function s(a,b,g,h){var i,j,k,m=!1;g=g||c,h=typeof h===e?d:h,i=f(a,g),j=f(b,g);for(var n=0,o=j.length;o>n;n++)if(k=l(i,j[n],h||2),k.length){m=!0;break}return m}
      function t(a,b,g,h){var i,j,k,m=!0;g=g||c,h=typeof h===e?d:h,i=f(a,g),j=f(b,g);for(var n=0,o=j.length;o>n;n++)if(k=l(i,j[n],h||2),!k.length){m=!1;break}return m}
      var b=a,c=",",d=0,e="undefined";
      return b.apl=m,b.rfl=p,{add:m,update:n,remove:p,removeAt:q,indexesOf:l,containsAny:s,containsAll:t}
    }(s);
    ...
    *********************************************************************/
    ...
    function k(a,b){a=i(a),d[a]=b}var b=a,c=!1,d={},e={pageKey:"page_key",linkProp:"prop25"},f={};return{setConfig:g,update:h,set:k,get:j}
    }(s);
    ...
    s.manageTransactions=function(a){
      function g(a){f="object"==typeof a?b.union(c,a):b.union(c,{}),b.Util&&b.Util.cookieRead&&b.Util.cookieWrite?(d=b.Util.cookieRead,e=b.Util.cookieWrite):b.c_rr&&b.c_wr?(d=b.c_rr,e=b.c_wr):(d=b.c_r,e=b.c_w),h()}
      function h(){var a=!1,c="";return b[f.customProp]?(a=!0,b.refreshAndPersist(b[f.customProp],f.cookieName,-1),b[f.customProp]=""):d(f.cookieName)||b.refreshAndPersist(b.guidGenerator(f.pattern),f.cookieName,-1),(b.manageEvents.containsAny(f.events)||f.fireOnCustom&&a)&&(c=d(f.cookieName),b.transactionID=c,b.refreshAndPersist(b.guidGenerator(f.pattern),f.cookieName,-1)),c}
      var d,e,b=a,c={events:"event68",customProp:"_xact",cookieName:"xact",fireOnCustom:!1,pattern:"xxxxxxxxxxxxxxxx_xxxxxxxxxxxxxxxx"},f={};
      return{init:g,update:h}
    }(s);
    /*!********************************************************************
    ...
    s.manageVisitor=function(a){
      "use strict";
      function g(a){c=!0,f="function"==typeof b.union?b.union(e,a):e}
      function h(){var a,c;return f||g({}),a=b.refreshAndPersist("",f.visitCookie,f.visitDurationInMin),c=b._visitID||a||b.guidGenerator(f.noSyncVisitPattern,f.noSyncVisitRadix),b.refreshAndPersist(c,f.visitCookie,f.visitDurationInMin),c}
      function i(){var a,c;return f||g({}),a=b.refreshAndPersist("",f.visitorCookie,f.visitorDurationInMin),c=b._visitorID||b.visitorID||a||b.guidGenerator(f.noSyncVisitorPattern,f.noSyncVisitorRadix),b.refreshAndPersist(c,f.visitorCookie,f.visitorDurationInMin),c}
      function j(){return f||g({}),b._visit?b._visit.tabNumber||0:0}var f,b=a,c=!1,e={visitCookie:"tmsvisit",visitorCookie:"tmsvisitor",noSyncVisitorPattern:"xxxxxxxxxxxxxxxx^xxxxxxxxxxxxxxxx",noSyncVisitorRadix:16,noSyncVisitPattern:"xx^xxxxxxx",noSyncVisitRadix:36,visitDurationInMin:30,visitorDurationInMin:525600};
      return{setConfig:g,getVisit:h,getVisitor:i,getTab:j}
    }(s);
    
    /*!*******************************************************************
    * Plugin: MboxUpdateOnEvents v1.1
    **********************************************************************/
    s.MboxUpdateOnEvents=function(){function a(){this.map={}}return a.prototype.add=function(a,b,c){a&&b&&(c=c||"global_mbox",this.map[a]={mbox:c,event:b})},a.prototype.trigger=function(a){try{var b,c,e,d=String(a).split(",");if(!a||!window.mboxUpdate)return;for(var f=0,g=d.length;g>f;f++)b=d[f],c=this.map[b],c&&(e=Array.prototype.slice.call(arguments,1),e.unshift(c.event),"function"==typeof mboxTrack?mboxTrack(c.mbox,e.join("&")):"function"==typeof mboxUpdate&&(e.unshift(c.mbox),mboxUpdate.apply(null,e)),baker("target update sent"))}catch(h){console.warn(h)}},new a}();
    ...
    *********************************************************************/
     ...
     *********************************************************************/
    s.refreshAndPersist=function(a,b,c){"use strict";var d=this,e=new Date;try{b=b||"campaign",c=parseFloat(c)||30,c>=0?e.setTime(e.getTime()+1e3*60*c):e="",a=a||d.c_r(b),d.c_wr?d.c_wr(b,a,e):d.c_w(b,a,e)}catch(f){}return a};
    ...
    *********************************************************************/
    ...
    s.vehicleData=function(a){
      function e(a){var b=String(a).toString().toLowerCase();return b=b.replace(/(\s|\-)/g,"")}
      function f(a,b){var g,f="",i=e(a);if(b=b||"name",i&&(g=c[i],g&&g[b]&&(f=g[b]),!f))try{f="function"==typeof d?d(a,i,b):h(a,i,b)}catch(j){f=""}return f}
      function g(a){"function"==typeof a&&(d=a)}
      function h(a,b,c){var d="";return"name"===c&&(d=b),d}
      function i(a){return f(a,"name")}
      function j(a){return f(a,"type")}
      function k(a,b){var d=e(a);c[d]={name:a,type:b}}
      function l(a,b){if(a&&b&&b.length)for(var c=0,d=b.length;d>c;c++)k(b[c],a)}
      function m(){c={},d=null}var d,c={};
      return{getName:i,getType:j,addData:k,addCatchAll:g,addModelsByType:l,clear:m}
    }(s);
    ...
    *********************************************************************/
    ...
    s.vehicleData.addModelsByType("Coupe", ["ISC","SC", "RC", "RC F"]);
    s.vehicleData.addModelsByType("SUV", ["GX","LX", "RX", "NX"]);
    ...
    s.vehicleData.addModelsByType("Future Concept", ["LF-LC","LF-CC","NEL","LF-NX","Concept Coupe","GS F","LF-C2"]);
